...
Value *BogusControlFlow::createBogusCmp(BasicBlock *insertAfter) {
  ...
  auto *xptr = new GlobalVariable(
      *M, TYPE_I32, false, GlobalValue::CommonLinkage, CONST_I32(0), "x");
  auto *yptr = new GlobalVariable(
      *M, TYPE_I32, false, GlobalValue::CommonLinkage, CONST_I32(0), "y");
  auto *x = new LoadInst(TYPE_I32, xptr, "", insertAfter);
  auto *y = new LoadInst(TYPE_I32, yptr, "", insertAfter);
  auto *cond1 = new ICmpInst(*insertAfter, CmpInst::ICMP_SLT, y, CONST_I32(10));
  BinaryOperator *op1 =
  ...
  auto *cond2 = new ICmpInst(*insertAfter, CmpInst::ICMP_EQ, op3, CONST_I32(0));
...
FunctionPass *llvm::createBogusControlFlow(bool enable) {
