...
static cl::opt<int>
    ObfTimes("mba-times", cl::init(1),
             cl::desc("Run MBAObfuscation pass <mba-times> time(s)"));

static cl::opt<int>
    ObfProb("mba-prob", cl::init(40),
      ...
      for (BasicBlock &BB : F) {
        ...
        for (Instruction *I : origInst) {
          if (isa<BinaryOperator>(I)) {
            ...
            for (unsigned long j = 0; j < I->getNumOperands(); j++) {
...
void MBAObfuscation::substituteConstant(Instruction *I, unsigned int i) {
