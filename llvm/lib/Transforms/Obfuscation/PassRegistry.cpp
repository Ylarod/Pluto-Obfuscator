...
cl::opt<bool> RunHelloWorld("hlw", cl::init(false),
                            cl::desc("Enable the HelloWorld pass"));

cl::opt<bool> RunFlattening("fla", cl::init(false),
                            cl::desc("Enable the Flattening pass"));

cl::opt<bool>
    RunFlatteningEnhanced("fla-ex", cl::init(false),
                          cl::desc("Enable the Enhanced Flattening pass"));

cl::opt<bool> RunBogusControlFlow("bcf", cl::init(false),
                                  cl::desc("Enable the BogusControlFlow pass"));

cl::opt<bool> RunSubstitution("sub", cl::init(false),
                              cl::desc("Enable the Substitution pass"));

cl::opt<bool>
    RunGlobalsEncryption("gle", cl::init(false),
                         cl::desc("Enable the GlobalsEncryption pass"));

cl::opt<bool>
    RunVariableSubstitution("vsb", cl::init(false),
                            cl::desc("Enable the VariableSubstitution pass"));

cl::opt<bool>
    RunRandomControlFlow("rcf", cl::init(false),
                         cl::desc("Enable the RandomControlFlow pass"));

cl::opt<bool> RunTrapAngr("trap-angr", cl::init(false),
                          cl::desc("Enable the TrapAngr pass"));

cl::opt<bool> RunMBAObfuscation("mba", cl::init(false),
                                cl::desc("Enable the MBAObfuscation pass"));
...
void llvm::registerAllPasses(legacy::PassManagerBase &MPM) {
  ...
  MPM.add(createBogusControlFlow(RunBogusControlFlow));
